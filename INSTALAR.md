...
```bash
npx --yes --package=github:AHORAFLX/AHORA-SQL-MCP#v1.8.1 ahora-setup
```
...
```bash
npm install --omit=dev github:AHORAFLX/AHORA-SQL-MCP#v1.8.1 --prefix "%LOCALAPPDATA%\AHORA-SQL-MCP"
```
