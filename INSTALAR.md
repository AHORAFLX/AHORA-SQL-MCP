...
```bash
npx --yes --package=github:AHORAFLX/AHORA-SQL-MCP#v1.13.0 ahora-setup
```
...
```bash
npm install --omit=dev github:AHORAFLX/AHORA-SQL-MCP#v1.13.0 --prefix "%LOCALAPPDATA%\AHORA-SQL-MCP"
```
